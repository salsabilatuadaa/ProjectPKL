...
<div>
    ...
    @if($atasan->isEmpty() || is_null($atasan->first()->nama))
                ...
                <!-- <form action="{{ route('simpan-profile') }}" method="POST" role="form text-left"> -->
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="email" class="form-control-label">Email</label>
                            <div class="@error('email')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{ auth()->user()->email }}" style="color: black;" type="email" placeholder="email" id="email" name="email" required disabled>
                                    @error('email')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                        ...
                        <div>
                            <label for="lokasi_kerja" class="form-control-label">Lokasi Kerja</label>
                            <div class="@error('lokasi_kerja')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{ $ats->lokasi_kerja }}" style="color: black;" type="lokasi" id="lokasi_kerja" name="lokasi_kerja" required disabled>
                                    @error('lokasi')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
