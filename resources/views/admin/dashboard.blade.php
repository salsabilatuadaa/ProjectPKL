  ...
  <div class="col-lg-5 mb-lg-0 mb-4">
    <div class="card z-index-2">
      <div class="card-body p-3">
        ...
        <h6 class="ms-2 mt-4 mb-0"> Cuti Tiap Tahun Karyawan</h6>
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Cuti Tahunan</p>
                <h5 class="font-weight-bolder mb-0">
                  12
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Cuti Lainnya</p>
                <h5 class="font-weight-bolder mb-0">
                  0
                  <span class="text-success text-sm font-weight-bolder"></span>
                </h5>
            ...
            <div class="col-4 text-end">
              <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                <i class="ni ni-paper text-lg opacity-10" aria-hidden="true"></i>
              </div>
            </div>
          </div>
        </div>
