                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    @foreach ($cutikaryawan as $cutiItem)
                                        <tr >
                                            ...
                                            <th class="text-left text-xs font-medium text-gray-500 uppercase tracking-wider text-center">
                                                <a href="/setujui-pengajuan-hr/{{ $cutiItem->id }}" class="btn btn-danger btn-sm float-right" onclick="return confirmAction('ACC')">Setuju</a>
                                            </th>
                                            <th class="text-left text-xs font-medium text-gray-500 uppercase tracking-wider text-center">
                                                <a href="/tolak-pengajuan-hr/{{ $cutiItem->id }}" class="btn btn-danger btn-sm float-right" onclick="return confirmAction('Tolak')">Tolak</a>
                                            </th>
